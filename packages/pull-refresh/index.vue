<template>
  <div :class="createClass()">
    ...
    >
      <div :class="createClass('head')">
        <slot v-if="status === 'normal'" name="normal" />
        <slot v-if="status === 'pulling'" name="pulling">
          <span :class="createClass('text')">{{ pullingText }}</span>
        </slot>
        <slot v-if="status === 'loosing'" name="loosing">
          <span :class="createClass('text')">{{ loosingText }}</span>
        </slot>
        <slot v-if="status === 'loading'" name="loading">
          <div :class="createClass('loading')">
